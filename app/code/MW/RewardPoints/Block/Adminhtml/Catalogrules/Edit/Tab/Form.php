    ...
    implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $dataCatalogRules = $this->_backendSession->getDataCatalogRules();
        if ($dataCatalogRules) {
            $form->setValues($dataCatalogRules);
            $this->_backendSession->getDataCatalogRules();
        } else {
            $dataCatalogRules = $this->_coreRegistry->registry('data_catalog_rules');
            if ($dataCatalogRules) {
                $form->setValues($dataCatalogRules);
            }
        }
