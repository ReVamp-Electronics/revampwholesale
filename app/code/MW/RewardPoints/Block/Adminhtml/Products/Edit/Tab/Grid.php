...
namespace MW\RewardPoints\Block\Adminhtml\Products\Edit\Tab;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header'=> __('Reward Points Earned'),
                'width' => '50px',
                'type'  => 'number',
                ...
                'editable' => true,
                'sortable' => false,
                'renderer' => 'MW\RewardPoints\Block\Adminhtml\Renderer\Rewardpoints',
            ]
        );
