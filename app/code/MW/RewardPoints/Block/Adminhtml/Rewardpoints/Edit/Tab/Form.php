...
namespace MW\RewardPoints\Block\Adminhtml\Rewardpoints\Edit\Tab;
    ...
    implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('mw_rewardpoints_import_form_');

        $fieldset = $form->addFieldset(
			'rewardpoints_form',
			['legend'=>__('Import Reward Points')]
		);
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label'     => __('CSV File'),
                'required'  => true,
                'note'      => __('CSV (Customer Id, Customer Email, Reward Points)')
            ]
        );
