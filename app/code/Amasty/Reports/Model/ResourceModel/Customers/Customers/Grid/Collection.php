...
class Collection extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    ...
    public function __construct(
        ...
        $resourceModel = '\Amasty\Reports\Model\ResourceModel\Customers\Customers\Collection'
    ) {
...
/*
    public function getSelectCountSql()
    {
        ...
        $countSelect->from(['main_table' => $this->getConnection()->getTableName('customer_entity')]);
